...
conf.ratio = conf.windowWidth / conf.windowHeight
conf.gameWidth, conf.gameHeight = math.floor(288 * (tonumber(tostring(conf.ratio):match("%d*%.?%d.")) - 0.1)), 288   --fixed game resolution
-- conf.gameWidth, conf.gameHeight = 800, 600
